<?php
    function Createdb(){
        ...
        function insertState(){
            ...
            $sql4 = "INSERT INTO state(id, state) VALUES
            ...
            /*if(mysqli_query($con,$sql4)){
                echo "States inserted into table...";
            }else{
                echo "Cannot insert into state table!!!";
            }*/
        }
        ...
        function insertCity(){
            ...
            $sql5 = "INSERT INTO city(id, state_id, city) VALUES
            ...
            /*if(mysqli_query($con,$sql5)){
                echo "Cities inserted into table...";
            }else{
                echo "Cannot insert into city table!!!";
            }*/
        }
            ...
            if(mysqli_query($con,$sql1)){
                ...
                if(mysqli_query($con,$sql2)){
                    ...
                    if(mysqli_query($con,$sql3)){
                        ...
                        echo "Cannot create city table!!!";
                    }
                }else{
                    echo "Cannot create state table!!!";
                }
            }else{
                echo "Cannot create employee table!!!";
            }
